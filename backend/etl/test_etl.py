...
def test_etl_pipeline():
    ...
    b1 = httpx.get("http://localhost:8000/bank1/transactions").json()
    b2 = httpx.get("http://localhost:8000/bank2/transactions").json()
    ...
    for tx in all_txns:
        ...
        db.merge(txn_obj)  # merge avoids duplicate primary key issues

        # Optional: print suspicious
